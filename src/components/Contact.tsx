  ...
  return (
    <section id="contact" className="py-20 px-6">
      ...
      >
        ...
        <Card className="p-4 sm:p-6 md:p-12 bg-card border-border shadow-card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {/* Email */}
            <div className="flex items-center gap-4 p-4 rounded-lg border border-border bg-secondary/50 w-full">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex gap-4 w-full justify-center">
              <Button
                variant="default"
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow ml-3 scale-95"
                onClick={() =>
                  window.open("https://github.com/balaji-matta18", "_blank")
                }
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-border hover:bg-secondary mr-3 scale-95"
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/matta-balaji/",
                    "_blank"
                  )
                }
              >
