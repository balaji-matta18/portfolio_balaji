...
const projects = [
  {
    title: "SpendBuddy",
    description: "RESTful API for expense tracking with budget management, category organization, and multi-user support using layered service-repository architecture.",
    tech: ["Spring Boot", "JWT", "MySQL", "Docker", "AWS Elastic Beanstalk", "GitHub Actions"],
    highlights: [
  ...
  {
    title: "NASA-APOD",
    description: "Full-stack application for exploring NASA's daily and historical astronomy pictures with advanced filtering capabilities.",
  ...
  {
    title: "HireLog",
    description: "Full-stack job application management system using Spring MVC with server-side rendering for job postings.",
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="p-2 rounded-lg border border-border hover:border-primary hover:bg-primary/5 transition-all">
